...
from utils import get_special_directions, get_matrix_directions
import pyvene as pv
...
def main(): 
    ...
    # print(f"list(dataset['question']): {list(dataset['question'])}")
    # print(f"list(df['Question']): {list(df['Question'])}")

    dataset_questions = list(dataset['question'])
    df_questions = list(df["Question"])

    # # Check lengths
    # print(f"Length of dataset questions: {len(dataset_questions)}")
    # print(f"Length of df questions: {len(df_questions)}")

    # # Find and print differences
    # if len(dataset_questions) == len(df_questions):
    #     print("Both lists have the same length. Checking for content differences...")
    #     differences = []
    #     for i, (q1, q2) in enumerate(zip(dataset_questions, df_questions)):
    #         if q1 != q2:
    #             differences.append((i, q1, q2))
    #             if len(differences) <= 5:  # Print first 5 differences
    #                 print(f"Difference at index {i}:")
    #                 print(f"dataset: '{q1}'")
    #                 print(f"df: '{q2}'")
    #     print(f"Found {len(differences)} differences out of {len(dataset_questions)} questions")
    # else:
    #     print("Lists have different lengths. Showing first and last few items from each:")
    #     print("\nFirst 3 items from dataset:")
    #     for q in dataset_questions[:3]:
    #         print(f"  '{q}'")
    #     print("\nFirst 3 items from df:")
    #     for q in df_questions[:3]:
    #         print(f"  '{q}'")
        
    #     print("\nLast 3 items from dataset:")
    #     for q in dataset_questions[-3:]:
    #         print(f"  '{q}'")
    #     print("\nLast 3 items from df:")
    #     for q in df_questions[-3:]:
    #         print(f"  '{q}'")
    ...
    #     print(f"Using Gemma-specific head_dim: {head_dim}")
    # else:  # Llama and other models
    #     head_dim = model.config.hidden_size // num_heads
    #     print(f"Using standard head_dim calculation: {head_dim}")
